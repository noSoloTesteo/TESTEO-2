...
''' + bcolors.ENDC + '--------------------------------------------------------------')
try:
	server = raw_input(bcolors.OKGREEN + 'Mail k: ' + bcolors.ENDC)
	user = raw_input(bcolors.OKGREEN + 'Your k: ' + bcolors.ENDC)
	pwd = getpass.getpass(bcolors.OKGREEN + 'k: ' + bcolors.ENDC)
